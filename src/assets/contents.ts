...
export const getReply = <T extends keyof typeof replies>(
    x: T,
    options: InteractionReplyOptions,
    ...args: ArgumentTypes<typeof replies[T]>
...
export const preconditionData = <T extends keyof typeof commandDatas.preconditions>(
    x: T
): typeof commandDatas.preconditions[T] => {
    return commandDatas.preconditions[x];
};
export const getVar = <T extends keyof typeof contents, U extends keyof typeof contents[T]>(
    x: T,
    y: U,
    value: string,
    split = true
